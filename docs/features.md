...
#### Офлайн-режим с локальным сохранением изменений ✅ (Реализовано 16.04.2026)
- Персистентное сохранение локальных изменений задач в IndexedDB при офлайн-режиме
- Автоматическое применение локальных изменений при открытии задачи
- Синхронизация изменений с бэкендом при восстановлении соединения
