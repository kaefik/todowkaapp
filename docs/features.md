...
- **Мультиязычный интерфейс (i18n) ✅ (Реализовано 26.04.2026)**
  - Русский (RU) и английский (EN) языки из коробки
  - Легко добавить новый язык: скопировать папку переводов и перевести строки
  - Библиотека: react-i18next + i18next
  - 9 namespace'ов для организации переводов: common, nav, auth, tasks, settings, projects, notifications, sync, verbs
  ...
  - Файлы: `frontend/src/i18n/`, `frontend/src/i18n/locales/ru/`, `frontend/src/i18n/locales/en/`
