...
type ContextFormData = z.infer<ReturnType<typeof useContextSchema>>
...
function ContextsContent() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{t('contexts')}</h1>
      ...
      {contexts.length === 0 && !isLoading && !isCreating && (
        <div className="text-center py-12">
          <p className="text-gray-500 dark:text-gray-400 text-lg">{t('noContexts')}</p>
